...
const textSignals: Array<[RegExp, string]> = [
  ...
  [/\bincome certificate\b/i, "income_certificate"],
  [/\b(?:domicile|residence) certificate\b/i, "domicile_certificate"],
  [/\bsalary slip|payslip|gross salary|net pay\b/i, "salary_slip"],
  [/\bpaytm statement|upi statement|payment statement\b/i, "payment_statement"],
  ...
  [/\bdegree certificate|convocation|(?:provisional|provision) certificate\b/i, "degree_certificate"],
  [/\bschool certificate|school leaving certificate\b/i, "school_certificate"],
  [/\bmarksheet|statement of marks|marks memo|\b(?:gre|ielts|trf)\b/i, "marksheet"],
  ...
  [/\b(?:i\s*20|i-20|form i-20|visa approval|visa granted|\bvisa\b)\b/i, "visa_approval"],
];
